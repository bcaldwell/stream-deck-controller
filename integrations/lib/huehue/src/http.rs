...
fn build_base() -> ClientBuilder {
	reqwest::Client::builder().add_root_certificate(Certificate::from_pem(CERTIFICATE.as_bytes()).unwrap())
	// todo: figure out if this is needed, doesn't work well with rusttls
